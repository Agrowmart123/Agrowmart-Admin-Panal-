...
export default function ProfilePage() {
  ...
  return (
    <div>
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 px-4 py-2 text-xl font-medium "
      >
        <ArrowLeft size={16} />
        Back
      </button>
        ...
        <div className="bg-white w-full max-w-7xl rounded-lg shadow-md p-6 md:p-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between bg-white p-6 rounded-lg mb-6">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h2 className="text-lg font-semibold">Myron Buchanan</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="font-medium text-gray-800">Brian Blackwood</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium text-gray-800">Pune</p>
              </div>

              <div>
                <p className="text-xs text-gray-500 mb-1">Pin</p>
                <p className="font-medium text-gray-800">411035</p>
              </div>

              <div>
                <p className="text-xs text-gray-500 mb-1">Address</p>
                <p className="font-medium text-gray-800">
                  123, Baner rd, Pune, Maharashtra
                </p>
              </div>
            </div>

            {/* Documents Section */}
            <h3 className="text-lg font-semibold mt-10 mb-5">Documents</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                ...
                <p className="font-medium text-gray-800">EST-269860798-31020</p>
              </div>

              <div>
                <p className="text-xs text-gray-500 mb-1">Vehicle Number</p>
                <p className="font-medium text-gray-800">GT 74 B GH</p>
              </div>

              <div>
                <p className="text-xs text-gray-500 mb-1">Transport Type</p>
                <p className="font-medium text-gray-800">Bike (Two Wheeler)</p>
              </div>
            </div>
