      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-200 hover:border-green-500 rounded-md focus:outline-none bg-white"
          />
        </div>
      </div>
          ...
          <table className="w-full text-sm text-gray-600">
            <thead>
              <tr className="bg-gray-100 text-xs text-gray-500">
                ...
                <th className="px-4 py-3 text-center">DELIVERED PRODUCTS</th>
                <th className="px-4 py-3 text-center">EARNING</th>
                <th className="px-4 py-3 text-center">DRIVING LICENSE NO.</th>
            ...
            <tbody>
              {paginatedData.map((p, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-center">{p.license}</td>
